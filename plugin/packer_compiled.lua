...
_G.packer_plugins = {
  ...
  colorschemes = {
    loaded = true,
    path = "/home/vagrant/.local/share/nvim/site/pack/packer/start/colorschemes",
  ...
  ["tokyonight.nvim"] = {
    loaded = true,
    path = "/home/vagrant/.local/share/nvim/site/pack/packer/start/tokyonight.nvim",
  ...
  ["vim-dispatch"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/vagrant/.local/share/nvim/site/pack/packer/opt/vim-dispatch",
